...
@section('title', 'Reset password — ' . config('app.name', 'KMSAR'))
...
<div class="kmsar-login">
    <div class="kmsar-login-brand">
        <div class="kmsar-login-brand-inner">
            ...
            <p class="kmsar-login-brand-sub">Choose a new password for your account.</p>
        </div>
    </div>
    ...
    <div class="kmsar-login-panel">
        <div class="kmsar-login-card">
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="kmsar-form-group">
                    <label class="kmsar-form-label" for="password_confirmation">Confirm password</label>
                    <input

...
@php
    $typeClass = match ($type) {
        'success' => 'kmsar-alert--success',
        'warning' => 'kmsar-alert--warning',
        'danger' => 'kmsar-alert--danger',
        default => 'kmsar-alert--info',
    };
...
<div {{ $attributes->class(['kmsar-alert', $typeClass]) }} role="alert">
